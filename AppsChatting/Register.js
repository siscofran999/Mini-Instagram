    ...
    submit(id,nama,email,pass, konfpass){
        if(id == null && nama == null && email == null && pass == null && konfpass == null){
            ...
            if(pass != konfpass){
                ...
                axios({
                    url: 'http://192.168.12.54/TA/register.php?id='+id+'&nama='+nama+'&email='+email+
                    '&pass='+pass+'&konfpass='+konfpass,
                    method: 'GET'
                }).then((data) => {
                    var api = data.data.Yes.id
                    ...
                    if(api){
                        ...
                        Alert.alert('Maaf, ID sudah pernah digunakan harap menggunakan ID yang lain')
