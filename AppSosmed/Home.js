...
export default class Home extends Component {
    ...
    home = async () => {
        ...
        axios({
            method: 'get',
            url: 'http://'+this.state.ip+'/TA/get_postHome.php?limit=10',
        }).then((data) => {
    ...
    logout(){
        ...
        AsyncStorage.removeItem('testing');
        AsyncStorage.removeItem('LihatProfil');
        AsyncStorage.removeItem('PicProfil');
        AsyncStorage.removeItem('image');
        AsyncStorage.removeItem('datapost');
        AsyncStorage.removeItem('mime');
        Actions.Loading();
    }
    ...
    more = async () => {
        ...
        axios({
            method: 'get',
            url: 'http://'+this.state.ip+'/TA/get_postHome.php?batas=5&lastid='+lastId,
        }).then((data) => {
    ...
    render() {
        ...
        <ListView
            ...
            renderRow={(rowData)=>
                ...
                <CardItem>
                    <Left>
                        <Thumbnail source={{uri: 'http://'+this.state.ip+'/TA/'+rowData.foto_profil}} />
                        <Body>
                ...
                <CardItem cardBody>
                    <TouchableOpacity onPress={() => {this.download(rowData.post,rowData.idpost)}}>
                        <Image source={{uri: 'http://'+this.state.ip+'/TA/'+rowData.post}} 
