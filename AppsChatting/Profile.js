...
export default class Profile extends Component {
    ...
    get_foto = async () => {
        ...
        axios({
            method: 'get',
            url: 'http://192.168.12.54/TA/get_foto.php?id='+this.state.id+'&nama='+this.state.nama,
        }).then((data) => {
            ...
            if(get_foto != ''){
                var link_foto = 'http://192.168.12.54/TA/'+get_foto
    ...
    selectPhotoTapped() {
        ...
        ImagePicker.showImagePicker(options, (response) => {
          ...
          if (response.didCancel) {
            ...
            axios({
                method: 'post',
                url: 'http://192.168.12.54/TA/save_foto.php',
                data: {
                    id: this.state.id,
    ...
    update = async (id, nama,email,link,bio) => {
        ...
        axios({
            method: 'post',
            url: 'http://192.168.12.54/TA/update_profile.php',
            data: {
                id: id,
                nama: nama,
                email: email,
